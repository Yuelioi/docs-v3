...
| exec | In |  |
| object | Target |  |
| name | Control Name | The name of the control to retrieve the offset transform for |
| enum | Space | The space to retrieve the offset transform in |
...
| --- | --- | --- |
| exec | Out |  |
| transform | Return Value | The offset transform of a control |
