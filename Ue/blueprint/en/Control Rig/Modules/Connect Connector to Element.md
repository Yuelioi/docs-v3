...
| exec | In |  |
| object | Target |  |
| struct | In Connector Key |  |
| struct | In Target Key |  |
| boolean | Setup Undo |  |
| boolean | Auto Resolve Other Connectors |  |
| boolean | Check Valid Connection |  |
...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Connect Connector to Element |
