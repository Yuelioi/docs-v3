---
display_name: Get Input Evaluation Distance to Oldest Sample Standard Deviation
order: 10
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| real | Return Value | Returns the standard deviation of the distance, in seconds, between evaluation time and oldest sample |
