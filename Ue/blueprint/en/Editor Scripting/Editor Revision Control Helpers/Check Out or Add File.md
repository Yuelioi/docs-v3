---
display_name: Check Out or Add File
order: 4
---
## Navigation
...
| --- | --- | --- |
| exec | In |  |
| string | In File | The file to check out/add - can be either fully qualified path, relative path, long package name, asset path or export text path (often stored on clipboard) |
