...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Trigger the translation phase, which populates the DatasmithScene.note that options should have been set before that and any modification to the scene made prior will be lost. |
