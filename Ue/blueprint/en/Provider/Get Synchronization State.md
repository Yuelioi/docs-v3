...
| Type | Name | Description |
| --- | --- | --- |
| unsupported_enum_type: enum size is larger than a byte | Return Value | The state of the TimecodeProvider and if it's currently synchronized and the Timecode and FrameRate getters are valid. |
