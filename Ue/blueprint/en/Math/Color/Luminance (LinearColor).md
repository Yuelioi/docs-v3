---
display_name: Luminance (LinearColor)
order: 24
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Returns the perceived brightness of a color on a display taking into account the impact on the human eye per color channel: green > red > blue. |
