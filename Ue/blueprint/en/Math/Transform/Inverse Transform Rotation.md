...
| Type | Name | Description |
| --- | --- | --- |
| rotator | Return Value | Transform a rotator by the inverse of the supplied transform.For example, if T was an object's transform, this would transform a rotation from world space to local space. |
