---
title: Random Point in Bounding Box from Stream
order: 26
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| vector | Return Value | Returns a random point within the specified bounding box using the first vector as an origin and the second as the half size of the AABB. |
