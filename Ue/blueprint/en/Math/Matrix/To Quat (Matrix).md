...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Transform a rotation matrix into a quaternion.(Assumes Matrix represents a transform)@warning rotation part will need to be unit length for this to be right! |
