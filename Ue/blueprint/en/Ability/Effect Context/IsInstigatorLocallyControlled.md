---
display_name: IsInstigatorLocallyControlled
order: 9
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if the ability system component that instigated this is locally controlled |
