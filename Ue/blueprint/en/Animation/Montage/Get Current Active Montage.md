...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Get a current Active Montage in this AnimInstance.Note that there might be multiple Active at the same time. This will only return the first active one it finds. * |
