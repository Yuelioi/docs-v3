...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Get the current blend time of the Montage.If Montage reference is NULL, it will return the current blend time on the first active Montage found. |
