...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if the animation montage is currently active and playing.If reference is NULL, it will return true is ANY montage is currently active and playing. |
