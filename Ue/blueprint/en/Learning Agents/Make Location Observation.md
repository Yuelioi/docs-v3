...
| vector | Location | The location of interest to the agent. |
| transform | Relative Transform | The transform the provided location should be encoded relative to. |
| real | Location Scale | Used to normalize the data for this observation. |
