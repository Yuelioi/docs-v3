...
| name | Element Names | The names of the sub-observations. Must match what was given during Specify. |
| struct | Elements | The corresponding sub-observations. Must match what was given during Specify. |
