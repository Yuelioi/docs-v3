...
| transform | Relative Transform | The relative transform. |
...
| real | Scale Scale | The scale used to control the overall magnitude of the outputted scale action. |
...
| --- | --- | --- |
| exec | Out |  |
| transform | Out Transform | The output transform value. |
