...
| real | Relative Angle | The relative angle to transform the angle by. |
| real | Angle Scale | The scale used to control the overall magnitude of the outputted scale action. |
...
| vector | Visual Logger Angle Location | A location for the visual logger to display the angle in the world. |
...
| --- | --- | --- |
| exec | Out |  |
| real | Out Angle | The output angle value. |
