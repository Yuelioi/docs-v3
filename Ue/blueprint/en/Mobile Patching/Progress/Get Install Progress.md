---
display_name: Get Install Progress
order: 3
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Get the current installation progress. Between 0 and 1 for known progress, or less than 0 for unknown progress |
