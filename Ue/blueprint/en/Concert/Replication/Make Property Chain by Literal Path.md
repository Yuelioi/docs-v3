...
| --- | --- | --- |
| class | Class | The class in which to search for the property path |
| name | Path to Property | The path to the property |

## Outputs

| Type | Name | Description |
| --- | --- | --- |
| struct | Result | The resulting path |
| boolean | Return Value | Whether Result is valid. |
