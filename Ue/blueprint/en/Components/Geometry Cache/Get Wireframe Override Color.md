---
display_name: Get Wireframe Override Color
order: 10
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| linearcolor | Return Value | Get the wireframe override color, used when overriding the wireframe color is enabled. |
