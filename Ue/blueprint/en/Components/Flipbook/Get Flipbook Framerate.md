...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Get the nominal framerate that the flipbook will be played back at (ignoring PlayRate), in frames per second |
