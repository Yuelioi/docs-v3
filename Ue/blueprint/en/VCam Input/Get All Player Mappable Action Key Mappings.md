...
| Type | Name | Description |
| --- | --- | --- |
| struct | Player Mappable Action Key Mappings | Searches the currently active input system for all registered key mappings that are marked as Player Mappable. |
