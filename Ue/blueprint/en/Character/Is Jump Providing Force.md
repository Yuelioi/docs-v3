...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | True if jump is actively providing a force, such as when the jump key is held and the time it has been held is less than JumpMaxHoldTime.@see CharacterMovement->IsFalling |
