...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if a widget under the hit result is has a visibility that makes it hit testvisible. e.g. Slate widgets that return true for GetVisibility().IsHitTestVisible(). |
