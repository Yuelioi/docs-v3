---
display_name: Get Attribute Signal Formats
order: 9
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Returns a map of function names and their Data Types.Functions outside the Active Mode's channel span range are ignored. |
