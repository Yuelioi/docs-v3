...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Returns an array of valid attributes for the currently active mode.Attributes outside the Active Mode's channel span range are ignored. |
