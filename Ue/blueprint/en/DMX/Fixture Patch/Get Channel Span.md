...
| Type | Name | Description |
| --- | --- | --- |
| integer | Return Value | Returns the number of channels this Patch occupies with the Fixture functions from its Active Mode or 0 if the patch has no valid Active Mode |
