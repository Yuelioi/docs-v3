---
display_name: Has Project Persistent Download Dir
order: 53
---
## Navigation
...
| --- | --- | --- |
| boolean | Return Value | * Returns true if a writable directory for downloaded data that persists across play sessions is available |
