---
title: Get Overlay Material Names
order: 12
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| name | Return Value | Returns a list of all overlays known to the subsystemThis includes the default overlays listed in the camera calibration settingsas well as any of overlays that have been registered with this subsystem |
