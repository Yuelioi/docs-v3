...
| --- | --- | --- |
| enum | Session Type |  |
| enum | Scene Reconstruction Method |  |

## Outputs

| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | if a particular scene reconstruction method is supported with the specified session type on the current platform |
