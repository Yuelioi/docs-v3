...
| --- | --- | --- |
| enum | Session Type |  |
| enum | Session Tracking Feature |  |

## Outputs

| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | if a particular session feature is supported with the specified session type on the current platform |
