...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Test whether this type of session is supported by the current Augmented Reality platform.e.g. is your device capable of doing positional tracking or orientation only? |
