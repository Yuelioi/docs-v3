---
title: PolyPath To Array Of Vector2D
order: 20
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| vector2d struct | Return Value | Returns an array of 2D Vectors with the PolyPath vertex locations projected onto the XY plane. |
