---
display_name: Set Static Mesh Collision from Mesh
order: 14
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| object | Dynamic Mesh | Generates Simple Collision shapes for a Static Mesh Asset based on the input Dynamic Mesh. |
