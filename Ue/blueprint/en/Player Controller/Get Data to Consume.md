...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Get the async physics data to execute logic off of. This data should not be modified and will NOT make its way back. Should be called from async tick |
