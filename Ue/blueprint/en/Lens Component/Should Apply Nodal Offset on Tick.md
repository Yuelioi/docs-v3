---
display_name: Should Apply Nodal Offset on Tick
order: 27
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if nodal offset will be automatically applied during this component's tick, false otherwise |
