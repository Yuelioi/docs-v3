...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Can the element be promotedGenerally available when the element is a lighter representation of another element.Like an instance for example. |
