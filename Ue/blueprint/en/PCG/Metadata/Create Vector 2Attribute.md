---
title: Create Vector 2Attribute
order: 22
---
## Navigation
...
| object | Target |  |
| name | Attribute Name |  |
| vector2d struct | Default Value |  |
| boolean | Allows Interpolation |  |
| boolean | Override Parent |  |
...
| --- | --- | --- |
| exec | Out |  |
| object | Metadata | Create Vector 2Attribute |
