---
title: Remove Animation Notify Events by Track
order: 10
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| integer | Return Value | Removes Animation Notify Events found by Track within the Animation Sequence, and returns the number of removed name instances |
