---
display_name: Get Primary Asset Id from Object
order: 12
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Returns the Primary Asset Id for an Object, this can return an invalid one if not registered |
