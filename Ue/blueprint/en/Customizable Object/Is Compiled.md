...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Check if the CustomizableObject asset has been compiled. This will always be true in a packaged game, but it could be false in the editor. |
