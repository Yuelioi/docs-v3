...
| Type | Name | Description |
| --- | --- | --- |
| vector2d struct | Return Value | Gives size in unscaled world coordinates of the patch in the world, based off of UnscaledCoverage andtexture resolution (i.e., adds a half-pixel around UnscaledCoverage). |
