...
| --- | --- | --- |
| exec | In |  |
| object | Section | The section within which to set the range |
| integer | Start Frame | The desired start frame for this section |
| integer | End Frame | The desired end frame for this section |
