...
| --- | --- | --- |
| exec | In |  |
| object | Sequence | The sequence to use |
| struct | Tick Resolution | The tick resolution of the sequence, defining the smallest unit of time representable on this sequence |
