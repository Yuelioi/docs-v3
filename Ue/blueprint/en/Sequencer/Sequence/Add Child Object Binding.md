...
| --- | --- | --- |
| exec | In |  |
| object | Folder | The folder to add a child object to |
| struct | In Object Binding | The binding to add to the folder |
...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | True if the addition is successful |
