...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Find all object binding IDs associated with the specified tag name (set up through RMB->Expose on Object bindings from within sequencer) |
