...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Tangent Weight. Represents the length of the hypotenuse in the form of "sqrt(x*x+y*y)" using the same definitions for x and y as tangents. |
