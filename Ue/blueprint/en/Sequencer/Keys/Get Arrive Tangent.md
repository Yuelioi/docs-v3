---
display_name: Get Arrive Tangent
order: 18
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Arrival Tangent value. Represents the geometric tangents in the form of "tan(y/x)" where y is the key's value and x is the seconds (both relative to key) |
