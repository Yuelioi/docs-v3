...
Returns the current value of InputAction /VirtualCamera/Modifiers/ClipPlaneModifier/Input/ClipPlaneAxis.ClipPlaneAxis. If input is disabled for the actor the value will be 0.
