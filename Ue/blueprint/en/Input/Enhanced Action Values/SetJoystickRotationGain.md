...
Returns the current value of InputAction /VirtualCamera/Modifiers/JoystickModifier/Inputs/SetJoystickRotationGain.SetJoystickRotationGain. If input is disabled for the actor the value will be 0.
