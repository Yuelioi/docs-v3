...
Returns the current value of InputAction /VirtualCamera/Modifiers/SequencerModifier/Inputs/PreviousFrame.PreviousFrame. If input is disabled for the actor the value will be 0.
