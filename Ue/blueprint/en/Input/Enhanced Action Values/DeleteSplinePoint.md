---
display_name: DeleteSplinePoint
order: 15
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/DeleteSplinePoint.DeleteSplinePoint. If input is disabled for the actor the value will be 0.
