...
Returns the current value of InputAction /VirtualCamera/Modifiers/StabilizationModifier/Inputs/SetRotationStabilization.SetRotationStabilization. If input is disabled for the actor the value will be 0.
