...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/CreateRigRail.CreateRigRail. If input is disabled for the actor the value will be 0.
