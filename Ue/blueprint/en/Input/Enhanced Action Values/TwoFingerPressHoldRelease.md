...
Returns the current value of InputAction /VirtualCamera/WidgetLibrary/VCamGestureWidget/Dependencies/TwoFingerPressHoldRelease.TwoFingerPressHoldRelease. If input is disabled for the actor the value will be 0.
