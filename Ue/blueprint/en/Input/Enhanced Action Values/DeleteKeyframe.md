...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/DeleteKeyframe.DeleteKeyframe. If input is disabled for the actor the value will be 0.
