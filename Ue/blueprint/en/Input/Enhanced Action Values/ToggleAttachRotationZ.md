---
display_name: ToggleAttachRotationZ
order: 103
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/ToggleAttachRotationZ.ToggleAttachRotationZ. If input is disabled for the actor the value will be 0.
