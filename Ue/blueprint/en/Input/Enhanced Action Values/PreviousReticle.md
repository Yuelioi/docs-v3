...
Returns the current value of InputAction /VirtualCamera/Modifiers/MaskAndOverlayModifier/Input/PreviousReticle.PreviousReticle. If input is disabled for the actor the value will be 0.
