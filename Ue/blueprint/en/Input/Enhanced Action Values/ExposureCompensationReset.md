---
display_name: ExposureCompensationReset
order: 19
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/ExposureCompensationReset.ExposureCompensationReset. If input is disabled for the actor the value will be 0.
