...
Returns the current value of InputAction /VirtualCamera/Modifiers/StabilizationModifier/Inputs/SetLocationStabilization.SetLocationStabilization. If input is disabled for the actor the value will be 0.
