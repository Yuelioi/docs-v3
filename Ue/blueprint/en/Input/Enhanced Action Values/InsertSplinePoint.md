---
display_name: InsertSplinePoint
order: 30
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/InsertSplinePoint.InsertSplinePoint. If input is disabled for the actor the value will be 0.
