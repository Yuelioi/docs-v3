...
Returns the current value of InputAction /VirtualCamera/Modifiers/MaskAndOverlayModifier/Input/PreviousOverlay.PreviousOverlay. If input is disabled for the actor the value will be 0.
