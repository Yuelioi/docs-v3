...
Returns the current value of InputAction /VirtualCamera/Modifiers/CameraBodyModifier/Input/Filmback.Filmback. If input is disabled for the actor the value will be 0.
