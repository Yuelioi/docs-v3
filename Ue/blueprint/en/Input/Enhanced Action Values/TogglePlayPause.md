...
Returns the current value of InputAction /VirtualCamera/Modifiers/SequencerModifier/Inputs/TogglePlayPause.TogglePlayPause. If input is disabled for the actor the value will be 0.
