...
Returns the current value of InputAction /VirtualCamera/Modifiers/SequencerModifier/Inputs/SetScrubSpeed.SetScrubSpeed. If input is disabled for the actor the value will be 0.
