...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Returns the current InputComponent on this utility actor. This will be NULL unless bReceivesEditorInput is set to true. |
