---
display_name: Get Current Reverb Effect
order: 13
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| object | Return Value | Returns the highest priority reverb settings currently active from any source (Audio Volumes or manual settings). |
