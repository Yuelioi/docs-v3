...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if this queue is the one that's currently rendering, returns false if it hasn't started yet, or if it's waiting in the queue, or if it has finished. |
