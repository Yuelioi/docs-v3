---
display_name: Get Display Value as String
order: 2
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| string | Return Value | Infers correct type internally, fetches value from memory and returns the value as a stringthat can be immediately used for dispaly (without needing to create a generic readonly property widget) |
