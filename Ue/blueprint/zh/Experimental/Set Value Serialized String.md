...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Sets the serialized value of this member. The string should be the serialized representation of the value. Returns true on success, else false. |
