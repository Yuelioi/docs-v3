...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Updates an existing variable assignment for the provided graph variable to a new enable state, or adds a newassignment and updates its enable state. Returns true on success, else false. |
