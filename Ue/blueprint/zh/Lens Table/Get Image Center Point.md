---
display_name: Get Image Center Point
order: 12
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| struct | Out Image Center Info |  |
| boolean | Return Value | Gets a Image Center point by given focus and zoom, if point does not exists returns false |
