...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Returns the active post process instance is one is available. This is set on the mesh that thiscomponent is using, and is evaluated immediately after the main instance. |
