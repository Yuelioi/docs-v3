---
display_name: Get OSC Message Integer (64-bit) at Index
order: 41
---
## Navigation
...
| exec | Out |  |
| int64 | Value |  |
| boolean | Succeeded | Set Value to Int64 at provided Index in OSCMessage if in bounds and type matches |
