...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if controlled by a human player (possessed by a PlayerController). This returns true for players controlled by remote clients |
