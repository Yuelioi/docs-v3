---
title: Get Scalar Parameter Value By Info
order: 24
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| real | Return Value | Get the current scalar (float) parameter value from an MID, using MPI (to allow access to layer parameters) |
