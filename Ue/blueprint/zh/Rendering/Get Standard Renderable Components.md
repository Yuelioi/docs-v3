...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Retrieves the list of primitive components that this water body uses when not being rendered by the water mesh (e.g. the static mesh component used when WaterMeshOverride is specified) |
