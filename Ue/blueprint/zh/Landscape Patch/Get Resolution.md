...
| Type | Name | Description |
| --- | --- | --- |
| vector2d struct | Return Value | Gets the size (in pixels) of the internal textures used by the patch. Does not reflect the resolutionof any used texture assets (if the source mode is texture asset). |
