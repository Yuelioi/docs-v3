...
| --- | --- | --- |
| exec | Out |  |
| object | Return Value | Return the pointer to the Interchange Manager singleton.@note - We need to return a pointer to have a valid Blueprint-callable function. |
