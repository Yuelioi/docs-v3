...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Add the skip node attribute. Use this function to cancel the creation of the Unreal asset. See ShouldSkipNodeImport for more documentation. |
