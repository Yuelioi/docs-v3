...
| Type | Name | Description |
| --- | --- | --- |
| string | Return Value | Optional. Any node that can import or export an asset should set the desired name for the asset.If the attribute was never set, returns GetDisplayLabel(). |
