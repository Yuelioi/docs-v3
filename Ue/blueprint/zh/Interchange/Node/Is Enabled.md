...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | If true, the node is imported or exported. If false, it is discarded.Returns false if the node was disabled. Returns true if the attribute is not there or if it was enabled. |
