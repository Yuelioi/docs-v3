...
| transform | Relative Transform | The transform the provided transform should be encoded relative to. |
| real | Location Scale | Used to normalize the transform's location for this observation. |
