...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Returns the platform user that is assigned to this Player Controller's Local Player.If there is no local player, then this will return PLATFORMUSERID_NONE |
