...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Gets a copy of all console variable overrides. These are not meant to be changed; use the mutator methods ifconsole variables need to be updated. |
