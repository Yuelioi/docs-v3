...
| --- | --- | --- |
| exec | In |  |
| name | Tag Name | The tag associated with the assets requested. |
| string | Tag Value | The value associated with the assets requested. |
...
| --- | --- | --- |
| exec | Out |  |
| string | Return Value | The list of asset found. |
