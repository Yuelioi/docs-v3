...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if this actor can EVER be selected in a level in the editor. Can be overridden by specific actors to make them unselectable. |
