---
display_name: Find Location Closest to World Location
order: 15
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| vector | Return Value | Given a location, in world space, return the point on the curve that is closest to the location. |
