---
title: Find Rotation Closest to World Location
order: 18
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| rotator | Return Value | Given a location, in world space, return rotation corresponding to the spline's rotation closest to the location. |
