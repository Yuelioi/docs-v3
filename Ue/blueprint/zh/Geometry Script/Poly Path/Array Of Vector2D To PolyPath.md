...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Returns a PolyPath created from an array of 2D position vectors. The Z-coordinate of the corresponding PolyPath vertices will be zero. |
