...
| Type | Name | Description |
| --- | --- | --- |
| integer | Vertex Count | Gets the number of vertices in the mesh. Note this may be less than the number of Vertex IDs used as some vertices may have been deleted. |
