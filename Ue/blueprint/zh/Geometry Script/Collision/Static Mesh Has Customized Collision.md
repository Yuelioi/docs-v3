---
title: Static Mesh Has Customized Collision
order: 17
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| boolean | Is Customized | true if the static mesh has customized collision. If no editor data is available, returns false. |
