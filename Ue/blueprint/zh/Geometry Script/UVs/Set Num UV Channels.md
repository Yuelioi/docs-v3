---
display_name: Set Num UV Channels
order: 21
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| object | Target Mesh | Set the number of UV Channels on the Target Mesh. If not already enabled, this will enable the mesh attributes. |
