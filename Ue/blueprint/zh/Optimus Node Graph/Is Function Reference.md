...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if the node in question is a function reference node that can be expandedinto a group of nodes using ExpandFunctionToNodes. |
