...
| exec | In |  |
| object | Target |  |
| object | In Node Output Pin |  |
| object | In Node Input Pin |  |
...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | @brief Removes a single link between two nodes.FIXME: Use UOptimusNodeLink instead. |
