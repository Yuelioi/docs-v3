---
display_name: Get Primary Asset Id from Class
order: 11
---
## Navigation
...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Returns the Primary Asset Id for a Class, this can return an invalid one if not registered |
