...
| Type | Name | Description |
| --- | --- | --- |
| real | Return Value | Get the current ML Deformer weight. A value of 0 means it is fully disabled, while 1 means fully active.Values can be anything between 0 and 1. |
