...
| --- | --- | --- |
| exec | Out |  |
| integer | Return Value | Increases the range of values of the integer with ParamName and returns the index of the new integer value, -1 otherwise.The added value is initialized with the first integer option and is the last one of the range. |
