...
| --- | --- | --- |
| exec | Out |  |
| integer | Return Value | Increases the range of values of the float with ParamName, returns the index of the new float value, -1 otherwise.The added value is initialized with 0.5f and is the last one of the range. |
