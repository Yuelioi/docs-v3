...
| --- | --- | --- |
| exec | Out |  |
| integer | Return Value | Remove the last of the float range of values from the parameter ParamName, returns the index of the last valid float, -1 if no values left. |
