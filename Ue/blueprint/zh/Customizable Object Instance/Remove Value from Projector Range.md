...
| --- | --- | --- |
| exec | Out |  |
| integer | Return Value | Remove the last of the projector range of values from the parameter ParamName, returns the index of the last valid projector, -1 if no values left. |
