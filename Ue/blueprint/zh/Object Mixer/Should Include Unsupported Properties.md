...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | If true, properties that are not visible in the details panel and properties not supported by SSingleProperty will be selectable.Defaults to false. |
