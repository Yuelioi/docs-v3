...
| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if the screen reader is currently active and accessibility services such as text to speech can be used by the screen reader users.Otherwise, it returns false. |
