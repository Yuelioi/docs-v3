...
| boolean | Angular Plasticity | Whether it is possible to reset the target angle from the angular displacement |
| real | Angular Plasticity Threshold | Degrees needed to reset the rest state of the joint |
