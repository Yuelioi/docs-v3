...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Get the Primary Configuration used to render this shot. This contains the global settings for the shot, as well as per-shotconfigurations which can contain their own settings. |
