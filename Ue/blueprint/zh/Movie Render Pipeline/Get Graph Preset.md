...
| Type | Name | Description |
| --- | --- | --- |
| object | Return Value | Gets the graph-style preset that this job is using. If the job is not using a graph-style preset, returns nullptr.@see GetPresetOrigin() |
