...
| --- | --- | --- |
| exec | Out |  |
| struct | Return Value | This instance of the effect will now grant NewGameplayTag to the object that this effect is applied to |
