...
| --- | --- | --- |
| exec | In |  |
| object | Folder | The folder to set the name of |
| name | In Folder Name | The new name for the folder |
...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | True if the setting of the folder name succeeds |
