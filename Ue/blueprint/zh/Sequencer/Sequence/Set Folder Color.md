...
| --- | --- | --- |
| exec | In |  |
| object | Folder | The folder to set the display color of |
| struct | In Folder Color | The new display color for the folder |
...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | True if the folder's display color is set successfully |
