...
| --- | --- | --- |
| exec | In |  |
| object | Level Sequence | The level sequence to play. |
| struct | Settings | The desired playback settings |
...
| --- | --- | --- |
| exec | Out |  |
| object | Out Actor | The level sequence actor created to play this sequence. |
| object | Return Value |  |
