...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Used in combination with Log().Assumes a quaternion with W=0 and V=theta\*v (where |v| = 1).Exp(q) = (sin(theta)\*v, cos(theta)) |
