...
| Type | Name | Description |
| --- | --- | --- |
| vector | Return Value | Transform a position by the inverse of the supplied transform.For example, if T was an object's transform, this would transform a position from world space to local space. |
