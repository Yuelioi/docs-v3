...
| Type | Name | Description |
| --- | --- | --- |
| string | Return Value | The Azure Cloud identifier of the spatial anchor is the persistent identifier by which a cloud anchor can be requested from the azure cloud service. Empty if the anchor has not been saved or loaded yet. |
