---
display_name: Get Custom Actors
order: 24
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| object | Return Value | Create an array with the CustomActor in the Datasmith scene that are at the root level of the hierarchy.Use RemoveCustomActor to modify the Datasmith scene. |
