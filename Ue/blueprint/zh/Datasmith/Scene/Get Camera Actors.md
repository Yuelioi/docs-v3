...
| --- | --- | --- |
| exec | Out |  |
| object | Return Value | Create an array with the CameraActor in the Datasmith scene that are at the root level of the hierarchy.Use CreateCameraActor -or- RemoveCameraActor to modify the Datasmith scene. |
