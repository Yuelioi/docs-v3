...
| --- | --- | --- |
| exec | Out |  |
| linearcolor | Return Value | Get the recorded value for this property as a linear color.Returned value is meaningless if the property is not of linear color type. |
