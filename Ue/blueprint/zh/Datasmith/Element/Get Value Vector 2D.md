...
| --- | --- | --- |
| exec | Out |  |
| vector2d struct | Return Value | Get the recorded value for this property as a vector2d.Returned value is meaningless if the property is not of vector2 type. |
