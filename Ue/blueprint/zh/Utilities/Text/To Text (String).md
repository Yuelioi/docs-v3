...
| Type | Name | Description |
| --- | --- | --- |
| text | Return Value | Converts string to culture invariant text. Use 'Make Literal Text' to create localizable text, or 'Format' if concatenating localized text |
