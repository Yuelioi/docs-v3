...
| --- | --- | --- |
| string | A | The string to compare against |
| string | B | The string to compare |

## Outputs

| Type | Name | Description |
| --- | --- | --- |
| boolean | Return Value | Returns true if the input strings are not equal, false if they are equal |
