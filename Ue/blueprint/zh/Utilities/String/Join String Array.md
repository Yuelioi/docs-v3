...
| --- | --- | --- |
| string | Source Array | The array of strings to concatenate. |
| string | Separator | The string used to separate each element. |

## Outputs

| Type | Name | Description |
| --- | --- | --- |
| string | Return Value | The final, joined, separated string. |
