...
| Type | Name | Description |
| --- | --- | --- |
| struct | Return Value | Converts the specified time from one framerate to another framerate. This is useful for converting between tick resolution and display rate. |
