...
Returns the current value of InputAction /VirtualCamera/Modifiers/MaskAndOverlayModifier/Input/NextReticle.NextReticle. If input is disabled for the actor the value will be 0.
