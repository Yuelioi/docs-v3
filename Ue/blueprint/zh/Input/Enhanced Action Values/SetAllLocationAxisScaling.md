...
Returns the current value of InputAction /VirtualCamera/Modifiers/AxisScalingModifier/Inputs/SetAllLocationAxisScaling.SetAllLocationAxisScaling. If input is disabled for the actor the value will be 0.
