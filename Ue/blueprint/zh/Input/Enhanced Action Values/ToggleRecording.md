...
Returns the current value of InputAction /VirtualCamera/Modifiers/TakeRecorderModifier/Inputs/ToggleRecording.ToggleRecording. If input is disabled for the actor the value will be 0.
