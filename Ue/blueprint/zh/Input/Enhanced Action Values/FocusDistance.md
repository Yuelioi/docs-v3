...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/FocusDistance.FocusDistance. If input is disabled for the actor the value will be 0.
