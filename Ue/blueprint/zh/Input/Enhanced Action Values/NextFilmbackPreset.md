---
display_name: NextFilmbackPreset
order: 36
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/CameraBodyModifier/Input/NextFilmbackPreset.NextFilmbackPreset. If input is disabled for the actor the value will be 0.
