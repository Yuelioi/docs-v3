---
display_name: FocalLengthPrecision
order: 23
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/FocalLengthPrecision.FocalLengthPrecision. If input is disabled for the actor the value will be 0.
