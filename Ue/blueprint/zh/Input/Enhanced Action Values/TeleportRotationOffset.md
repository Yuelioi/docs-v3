...
Returns the current value of InputAction /VirtualCamera/Modifiers/TeleportModifier/Input/TeleportRotationOffset.TeleportRotationOffset. If input is disabled for the actor the value will be 0.
