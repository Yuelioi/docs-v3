...
Returns the current value of InputAction /VirtualCamera/Modifiers/HoldModifier/Inputs/ToggleHold.ToggleHold. If input is disabled for the actor the value will be 0.
