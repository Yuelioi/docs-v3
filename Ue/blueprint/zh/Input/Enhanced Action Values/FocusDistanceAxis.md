---
display_name: FocusDistanceAxis
order: 25
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/FocusDistanceAxis.FocusDistanceAxis. If input is disabled for the actor the value will be 0.
