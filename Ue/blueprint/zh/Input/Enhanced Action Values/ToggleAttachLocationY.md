---
display_name: ToggleAttachLocationY
order: 99
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/ToggleAttachLocationY.ToggleAttachLocationY. If input is disabled for the actor the value will be 0.
