...
Returns the current value of InputAction /VirtualCamera/Modifiers/BookmarkModifier/Input/CurrentBookmark.CurrentBookmark. If input is disabled for the actor the value will be 0.
