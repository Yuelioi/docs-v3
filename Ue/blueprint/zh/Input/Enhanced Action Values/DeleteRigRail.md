...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/DeleteRigRail.DeleteRigRail. If input is disabled for the actor the value will be 0.
