...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/NextSplinePoint.NextSplinePoint. If input is disabled for the actor the value will be 0.
