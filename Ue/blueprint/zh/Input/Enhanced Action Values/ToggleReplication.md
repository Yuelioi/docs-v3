...
Returns the current value of InputAction /VirtualCamera/Modifiers/MultiUserModifier/Inputs/ToggleReplication.ToggleReplication. If input is disabled for the actor the value will be 0.
