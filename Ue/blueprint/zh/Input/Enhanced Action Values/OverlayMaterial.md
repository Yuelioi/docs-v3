...
Returns the current value of InputAction /VirtualCamera/Modifiers/MaskAndOverlayModifier/Input/OverlayMaterial.OverlayMaterial. If input is disabled for the actor the value will be 0.
