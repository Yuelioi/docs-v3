...
Returns the current value of InputAction /VirtualCamera/Modifiers/TeleportModifier/Input/Teleport.Teleport. If input is disabled for the actor the value will be 0.
