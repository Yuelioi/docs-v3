...
Returns the current value of InputAction /VirtualCamera/Modifiers/TakeRecorderModifier/Inputs/RecordingSpeed.RecordingSpeed. If input is disabled for the actor the value will be 0.
