...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/FocalLength.FocalLength. If input is disabled for the actor the value will be 0.
