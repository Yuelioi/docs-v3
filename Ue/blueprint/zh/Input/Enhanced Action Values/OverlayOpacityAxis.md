...
Returns the current value of InputAction /VirtualCamera/Modifiers/MaskAndOverlayModifier/Input/OverlayOpacityAxis.OverlayOpacityAxis. If input is disabled for the actor the value will be 0.
