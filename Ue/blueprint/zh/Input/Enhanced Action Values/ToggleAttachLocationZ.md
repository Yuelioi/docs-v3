---
display_name: ToggleAttachLocationZ
order: 100
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/ToggleAttachLocationZ.ToggleAttachLocationZ. If input is disabled for the actor the value will be 0.
