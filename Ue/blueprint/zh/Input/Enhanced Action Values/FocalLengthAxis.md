...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/FocalLengthAxis.FocalLengthAxis. If input is disabled for the actor the value will be 0.
