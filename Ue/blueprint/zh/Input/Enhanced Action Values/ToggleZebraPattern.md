---
display_name: ToggleZebraPattern
order: 122
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/VisualizationModifier/Input/ToggleZebraPattern.ToggleZebraPattern. If input is disabled for the actor the value will be 0.
