---
display_name: SetCurrentLocationAxisScaling
order: 71
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/AxisScalingModifier/Inputs/SetCurrentLocationAxisScaling.SetCurrentLocationAxisScaling. If input is disabled for the actor the value will be 0.
