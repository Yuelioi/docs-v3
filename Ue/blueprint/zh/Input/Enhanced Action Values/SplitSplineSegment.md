---
display_name: SplitSplineSegment
order: 85
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/SplitSplineSegment.SplitSplineSegment. If input is disabled for the actor the value will be 0.
