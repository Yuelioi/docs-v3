...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/AddSplinePoint.AddSplinePoint. If input is disabled for the actor the value will be 0.
