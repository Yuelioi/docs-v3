...
Returns the current value of InputAction /VirtualCamera/Modifiers/MaskAndOverlayModifier/Input/ReticleOpacityAxis.ReticleOpacityAxis. If input is disabled for the actor the value will be 0.
