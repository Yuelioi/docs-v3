...
Returns the current value of InputAction /VirtualCamera/Modifiers/TeleportModifier/Input/Aim.Aim. If input is disabled for the actor the value will be 0.
