---
display_name: PreviousShutterSpeed
order: 64
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/LensModifier/Inputs/PreviousShutterSpeed.PreviousShutterSpeed. If input is disabled for the actor the value will be 0.
