---
display_name: JumpToPreviousKey
order: 33
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SequencerModifier/Inputs/JumpToPreviousKey.JumpToPreviousKey. If input is disabled for the actor the value will be 0.
