---
display_name: GoToStartPosition
order: 28
---
## Navigation
...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/GoToStartPosition.GoToStartPosition. If input is disabled for the actor the value will be 0.
