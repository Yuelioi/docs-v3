...
Returns the current value of InputAction /VirtualCamera/Modifiers/JoystickModifier/Inputs/PlanarMovement.PlanarMovement. If input is disabled for the actor the value will be 0.
