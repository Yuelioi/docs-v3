...
Returns the current value of InputAction /VirtualCamera/Modifiers/ParentModifier/Input/SetCurrentParent.SetCurrentParent. If input is disabled for the actor the value will be 0.
