...
Returns the current value of InputAction /VirtualCamera/Modifiers/VisualizationModifier/Input/ZebraPatternThreshold.ZebraPatternThreshold. If input is disabled for the actor the value will be 0.
