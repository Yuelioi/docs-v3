...
Returns the current value of InputAction /VirtualCamera/Modifiers/KillRollModifier/Inputs/ToggleKillRoll.ToggleKillRoll. If input is disabled for the actor the value will be 0.
