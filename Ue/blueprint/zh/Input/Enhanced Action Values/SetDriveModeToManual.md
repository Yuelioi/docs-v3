...
Returns the current value of InputAction /VirtualCamera/Modifiers/SplineModifier/Input/SetDriveModeToManual.SetDriveModeToManual. If input is disabled for the actor the value will be 0.
