...
Returns the current value of InputAction /VirtualCamera/Modifiers/SensorCorrectionModifier/Input/ToggleSensorCorrection.ToggleSensorCorrection. If input is disabled for the actor the value will be 0.
