...
Returns the current value of InputAction /VirtualCamera/WidgetLibrary/VCamGestureWidget/Dependencies/DoubleTap.DoubleTap. If input is disabled for the actor the value will be 0.
