...
Returns the current value of InputAction /VirtualCamera/Modifiers/ZeroOutModifier/Inputs/ZeroToParent.ZeroToParent. If input is disabled for the actor the value will be 0.
