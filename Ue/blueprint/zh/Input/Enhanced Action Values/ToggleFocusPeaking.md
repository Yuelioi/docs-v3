...
Returns the current value of InputAction /VirtualCamera/Modifiers/VisualizationModifier/Input/ToggleFocusPeaking.ToggleFocusPeaking. If input is disabled for the actor the value will be 0.
