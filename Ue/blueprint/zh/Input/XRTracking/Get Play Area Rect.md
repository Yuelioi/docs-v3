...
| vector2d struct | Out Rect |  |
| boolean | Return Value | Get the transform and dimensions of the playable area rectangle. Returns false if none currently specified/available. |
