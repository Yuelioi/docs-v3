---
display_name: Get HMDDevice Name
order: 3
---
## Navigation
...
| --- | --- | --- |
| name | Return Value | FName specific to the currently active HMD device type. "None" implies no device, "Unknown" implies a device with no description. |
