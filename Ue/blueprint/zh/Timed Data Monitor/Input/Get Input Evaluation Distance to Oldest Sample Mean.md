---
display_name: Get Input Evaluation Distance to Oldest Sample Mean
order: 9
---
## Navigation
...
| --- | --- | --- |
| exec | Out |  |
| real | Return Value | Returns the min average distance, in seconds, between evaluation time and oldest sample |
