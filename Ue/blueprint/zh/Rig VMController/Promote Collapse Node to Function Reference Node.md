---
display_name: Promote Collapse Node to Function Reference Node
order: 75
---
## Navigation
...
| string | In Existing Function Definition Path |  |
...
| --- | --- | --- |
| exec | Out |  |
| name | Return Value | Turns a collapse node into a function node |
