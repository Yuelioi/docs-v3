...
| exec | In |  |
| object | Target |  |
| struct | In Function Definitions |  |
| boolean | Localize Dependent Private Functions |  |
...
| --- | --- | --- |
| exec | Out |  |
| struct | Return Value | Copies a series of function declaratioms into this graph's local function library |
