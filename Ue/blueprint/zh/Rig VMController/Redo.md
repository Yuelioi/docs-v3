...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Re-does the last action on the stack.Note: This should really only be used for unit tests,use the GEditor's main Undo method instead. |
