...
| --- | --- | --- |
| exec | Out |  |
| boolean | Return Value | Accessors from Blueprint. For now just exposing common types but ideally we can expose any somehow in future. |
